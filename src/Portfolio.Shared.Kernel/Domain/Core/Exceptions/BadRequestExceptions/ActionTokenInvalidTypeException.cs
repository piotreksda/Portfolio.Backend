...
public class ActionTokenInvalidTypeException : BadRequestException
{
    public ActionTokenInvalidTypeException() : base(ExceptionsTranslationsKeys.ActionTokenInvalidTypeMessage)
    {
